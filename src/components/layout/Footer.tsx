          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-primary-foreground/70 text-xs sm:text-sm">+91 98765 43210</span>
              </li>
              <li className="flex items-center gap-2 sm:gap-3">
                <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0" />
                <span className="text-primary-foreground/70 text-xs sm:text-sm">hello@storyseed.studio</span>
              </li>
            </ul>
          </div>
        </div>
